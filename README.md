...
1. download [latest release](https://github.com/kartFr/Auto-Animation-Stealer/releases/latest) and download python on the [microsoft store(latest release as of making this)](https://ms-windows-store://pdp/?ProductId=9NRWMJP3717K) or the [website](https://www.python.org/downloads/)
